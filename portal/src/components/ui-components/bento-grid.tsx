...
import Anthropic from "@/components/ui-components/anthropic";
import AnthropicDark from "@/components/ui-components/anthropic-dark";
import Google from "@/components/ui-components/gemini";
import OpenAI from "@/components/ui-components/open-ai";
import OpenAIDark from "@/components/ui-components/open-ai-dark";
import MistralAI from "@/components/ui-components/mistral";
import DeepSeek from "@/components/ui-components/deepseek";
...
const bentoItems: BentoItem[] = [
    {
        ...
        description:
            "Whether you’re exploring the world or protecting it, our platform brings peace of mind to every journey.",
        href: "#",
        feature: "spotlight",
        spotlightItems: [
            "Geo-fenced Safety Notifications",
    ...
    {
        id: "stat1",
        title: "Building Trust. Enabling Safe Journeys.",
        description:
            "Whether you’re exploring the world or protecting it, our platform brings peace of mind to every journey.",
        href: "#",
        feature: "typing",
        typingText:
            "For tourists, it’s a trusted safety companion. For authorities, it’s a powerful smart-response system. Together, our platform bridges security and peace of mind making every journey safer, smarter, and worry-free.",
        size: "md",
        className: "col-span-2 row-span-1 col-start-1 col-end-3",
    },
    {
        id: "partners",
        title: "Your Digital ID, Verified by Blockchain.",
        description:
            "Blockchain-based verification ensures tamper-proof digital IDs, making every passport, visa, and travel record secure, authentic, and instantly trusted worldwide.",
        icons: true,
        href: "#",
        feature: "icons",
        size: "md",
                        ...
                        >
                            <div className="p-5">
                                ...
                                <p className="text-sm text-neutral-600 dark:text-neutral-400 tracking-tight mb-4">
                                    AI-powered detection that spots risks instantly, sends alerts in real time, and triggers the right emergency response keeping you safe, always.
                                </p>
                                <AIInput_Voice />
                            </div>
                        </motion.div>
