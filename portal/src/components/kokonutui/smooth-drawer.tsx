...
export default function SmoothDrawer({
    title = "Download TourGuard",
    description = "TourGuard is Avaible for android, Download Now",
    primaryButtonText = "Download for Android",
    ...
    return (
        <Drawer>
            <DrawerTrigger asChild>
                <Button>Download App <DownloadIcon/> </Button>
            </DrawerTrigger>
                        ...
                        <DrawerFooter className="flex flex-col gap-3 px-0">
                            <div className="w-full">
                                <Link
                                    ...
                                    target="_blank"
                                    className="group w-full relative overflow-hidden inline-flex items-center justify-center h-11 rounded-xl  text-sm font-medium tracking-wide shadow-lg shadow-rose-500/20 transition-all duration-500 hover:shadow-xl bg-primary text-white"
                                >
                                    <motion.span
